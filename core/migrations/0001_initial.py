# Generated by Django 4.2.7 on 2026-05-08 21:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('admin', 'Administrador'), ('supervisor', 'Supervisor'), ('empleado', 'Empleado Hospital'), ('operador', 'Operador'), ('supervisor', 'Supervisor')], default='empleado', max_length=10)),
                ('numero_doc', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='Número de Documento')),
                ('tema_oscuro', models.BooleanField(default=False, verbose_name='Preferencia Modo Oscuro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origen', models.CharField(choices=[('COMPRA', 'Compra'), ('DONACION', 'Donación'), ('TRANSFERENCIA', 'Transferencia'), ('OMISION', 'Omisión')], default='COMPRA', max_length=15, verbose_name='Origen')),
                ('estado', models.CharField(choices=[('ACTIVO', 'Activo'), ('MANTENIMIENTO', 'Mantenimiento'), ('INACTIVO', 'Inactivo'), ('BAJA', 'Baja')], default='ACTIVO', max_length=50, verbose_name='Estado')),
                ...
                ('numero_compra', models.CharField(blank=True, max_length=50, null=True, verbose_name='N° de Compra')),
                ...
                ('siem', models.DateField(blank=True, null=True, verbose_name='SIEM')),
