# Generated by Django 5.1 on 2026-04-25 19:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["hash_archivo"], name="core_archiv_hash_ar_bc62ff_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                (
                    "clave_unica",
                    models.BigAutoField(
                        primary_key=True, serialize=False, verbose_name="Clave Única"
                    ),
                ),
                ...
                (
                    "cuenta_codigo",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="Cuenta Código"
                    ),
                ),
                (
                    "nomenclatura_bienes",
                ...
                (
                    "numero_serie",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="N° de serie"
                    ),
                ),
                (
                ...
                (
                    "numero_compra",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="N° de Compra"
                    ),
                ),
                (
                    "valor_adquisicion",
                ...
                (
                    "servicios",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Servicios"
                    ),
                ),
                (
                    "observaciones",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=100,
                        null=True,
                        verbose_name="Expediente Baja",
                    ),
                ),
                (
                    "descripcion_baja",
                    models.TextField(blank=True, verbose_name="Descripción de baja"),
                ),
                (
                    "expediente",
                    models.ForeignKey(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["clave_unica"], name="core_bienpa_clave_u_defa30_idx"
                    ),
                    models.Index(
                        fields=["estado"], name="core_bienpa_estado_d48784_idx"
                    ),
                ],
            },
        ),
